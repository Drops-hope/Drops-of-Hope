...
if (isset($_POST['newcampaign'])) {
    ...
    $qry = "INSERT INTO `campaigndb`(`cname`, `oname`, `phn`, `cdate`, `descp`) VALUES ('$cname','$oname','$phone','$cdate','$decrip')";
    $result = mysqli_query($conn, $qry);

    if ($result) {
        echo "<script>
        alert('newcampaign added');
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">New Campaign</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post">
                                        ...
                                        <button type="submit" name="newcampaign" href="" class="btn btn-success" style="border-radius:0%">Post</button>

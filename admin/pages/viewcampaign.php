				...
				<div class="row">
					<div class=".col-lg-12">
						...
						<tr>
						  ...
						  <td>
						  <a href='updatecampaign.php?id=" . $row['id'] . "'><i class='fa fa-edit ' style='color:green; margin: right 10px;'></i></a>
						  <a href='deletecampaign.php?id=" . $row['id'] . "'><i class='fa fa-trash' style='color:red; margin: right 10px;'></i></a>
						  </td>

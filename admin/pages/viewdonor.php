					...
					<div class=".col-lg-12">
						...
						while ($row = mysqli_fetch_array($result)) {
							echo "<tbody>
									...
									<td>" . $row['contact'] . "</td>
									<td>
									<a href='updatedonor.php?id=" . $row['id'] . "'><i class='fa fa-edit ' style='color:green; margin: right 10px;'></i></a>
									<a href='deletedonor.php?id=" . $row['id'] . "'><i class='fa fa-trash' style='color:red; margin: right 10px;'></i></a>
									</td>
